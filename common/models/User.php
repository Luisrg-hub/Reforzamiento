...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        // Relaciona el ID del usuario con el campo id_usuario del perfil
        return $this->hasOne(PerfilAdmin::class, ['id_usuario' => 'id']);
    }
    public function getPerfilDocente()
    {
        return $this->hasOne(PerfilDocente::class, ['id_usuario' => 'id']);
    }
}
