...
<header>
    <?php
    NavBar::begin([
        'brandLabel' => 'Panel Administración - TecNM',
   ...
   $menuItems = [
    ...
    // Gestión de la Estructura Escolar
    [
        'label' => 'Catálogos',
        'items' => [
    ...
    // Operaciones
    ['label' => 'Asignaciones', 'url' => ['/asignacion/index']],
    ['label' => 'Control de Sesiones', 'url' => ['/sesion/index']],
];
